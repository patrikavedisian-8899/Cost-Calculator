...
4. Add your deployed Vercel URL to Supabase Auth redirect URLs after deployment.
5. Fill in `app-config.js`:
...
4. After the first deploy, copy the Vercel URL into Supabase Auth redirect URLs.
5. Open the Vercel URL on your phone and laptop, then sign in with the same email.
